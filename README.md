...
Start on Dust 2, with crowdsourced CS:GO maps at the heart of the game's vision.
...
See the [tools and development guide](tools/README.md) for running the game, rebuilding assets, working with audio, and capturing screenshots.
